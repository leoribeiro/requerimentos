<?php
	...
	Yii::app()->user->setFlash('info', '<div id="containerL"><div id="primaryL2">'.CHtml::image($this->createUrl("images/registroescolar.png"),'').'</div><div id="contentL">'.CHtml::link($nomeR,array('Requerimentos/create',
'form'=>'RR')).'</div></div>');
