...
<?php
	...
	'columns'=>array(
		...
		array(
			...
			'viewButtonUrl'=>'Yii::app()->createUrl("Requerimentos/view", array("id" => $data->relRequerimento->CDRequerimento,"urlReq"=>$data->relRequerimento->relModeloRequerimento->SgRequerimento))',
			'updateButtonUrl'=>'Yii::app()->createUrl("Requerimentos/view", array("id" => $data->relRequerimento->CDRequerimento, "alterarSituacao"=> 1,"urlReq"=>$data->relRequerimento->relModeloRequerimento->SgRequerimento))',
