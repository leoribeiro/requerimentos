...
class SS_RequerimentoAlunoEstagio extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('CDRequerimentoAlunoEstagio, Ano, SS_Requerimento_CDRequerimento, AnoConclusao,NumRequerimento,Situacao,DtPedido,nomeAluno', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$modelS = SS_RequerimentoAlunoEstagio::model()->findAll($criteriaS);
		$ReqsID = array();
		...
		$criteria->order = 'Ano DESC,CDRequerimentoAlunoEstagio DESC'; 
	...
	public function scopes()
	{
	    return array(
	        'lastRecord'=>array(
	            //'condition'=>'',
	            'order'=>'Ano DESC,CDRequerimentoAlunoEstagio DESC',
	            'limit'=>1,
	        ),
	    );
	}
